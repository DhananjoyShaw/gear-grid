...
import {
    Button, Textarea, Select, SelectContent, SelectItem, SelectTrigger,
    SelectValue, Card, CardContent, Popover, PopoverContent, PopoverTrigger,
...
const TestDriveForm = ({ car, testDriveInfo }) => {
    ...
    useEffect(() => {
        ...
        setValue("timeSlot", "");    // Clear time slot selection when date changes
    }, [selectedDate]);
    ...
    const isDayDisabled = (day) => {
        ...
        const dayOfWeek = format(day, "EEEE").toUpperCase();    // Get day of week
        ...
        return !daySchedule || !daySchedule.isOpen;     // Disable if dealership is closed on this day
    };
                ...
                <Card className="mt-6">
                    <CardContent className="p-6">
                        ...
                        <div className="text-sm">
                            <p className="font-medium"> {dealership?.name || "GearGrid Motors"}  </p>
                                        ...
                                        <div>
                                            ...
                                            >
                                                <SelectTrigger>
                                                    <SelectValue
                                                        placeholder={
                                                            !selectedDate ? "Please select a date first" : availableTimeSlots.length === 0
                                                                ? "No available slots on this date" : "Select a time slot"
                                                        }
                                                    />
                                                </SelectTrigger>
                                                <SelectContent>
