import { ChevronRight, Car as CarIcon, Calendar, Shield } from "lucide-react";
    ...
    <div className="flex flex-col pt-20">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-4xl md:text-7xl mb-4 gradient-title">Find your Dream Car with <span className="text-5xl md:text-8xl mb-4 gradient-title"> GridGear AI </span></h1>
