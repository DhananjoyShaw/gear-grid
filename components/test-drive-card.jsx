...
import { Button, Card, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, } from "@/components/ui/index";
import { getTestDriveStatusBadge } from "@/lib/helpers";
                ...
                <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="sm:w-1/4 relative h-40 sm:h-auto">
                        ...
                        <div className="absolute top-2 right-2 sm:hidden">
                            {getTestDriveStatusBadge(booking.status)}
                        </div>
                    </div>
                    ...
                    {/* Action Buttons - Right */}
                    {
                        showActions && (
                            <div className="p-4 border-t sm:border-t-0 sm:border-l sm:w-1/4 sm:flex sm:flex-col sm:justify-center sm:items-center sm:space-y-2">
                                ...
                                <Button variant="outline" size="sm" className="w-full my-2 sm:mb-0" asChild >
                                    <Link
